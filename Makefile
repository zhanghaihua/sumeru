...
test-cov: sumeru-cov
	...
	@SUMERU_COV=1 $(MAKE) test REPORTER=mocha-lcov-reporter | sed "s/SF:/&sumeru-cov\//g" | COVERALLS_REPO_TOKEN="QPt6kZVAuajrqNB6DCb9Jhcd77zVXj7el" ./node_modules/coveralls/bin/coveralls.js
	@rm -rf sumeru-cov
