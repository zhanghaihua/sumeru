...
//build model
//require(libserverpath + '/serverModel.js')(fw);
...
var findDiff = require(libserverpath + '/findDiff.js')(fw);
...
var DbCollectionHandler = require(libserverpath + "/DbCollectionHandler.js")(fw);
...
var appendUserInfoNCallback = require(libserverpath + '/lib/appendUserInfoNCallback.js');
require(libserverpath  + '/../library/rsa/sumeru-rsa.js')(fw, getDbCollectionHandler, ObjectId);
...
require(libserverpath  + '/authServer.js')(fw, getDbCollectionHandler,ObjectId);

//Init poller
require(libserverpath + '/poller/poller.js')(fw,getDbCollectionHandler);
...
var runStub = function(db) {
    ...
    netMessage.setOutput(function(data,socketId,onerror,onsuccess){
        ...
        setTimeout( function(){ 
        	fw.onSumeruData(data2, {_sumeru_socket_id:"666666"}); 
        }, 200);
    });
...
var __sumeruready = false;

fw.sumeruReady = function(onready) {
	if (__sumeruready) {
		onready(__sumeruready);
	}
	else {
		setTimeout( function(){ fw.sumeruReady(onready); }, 200);
	}
}

fw.onSumeruData = function(msg, conn){
    //FIXME 做跨域连接检测和授权检查
...
require(libpath + "/session.js");
require(libpath + "/event.js");
...
require(libpath + "/collection.js");

//require(libpath + "/controller.js")(fw);
require(libpath + "/messageDispatcher.js");
